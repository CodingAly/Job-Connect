...
function toggleDisplay() {
	const option = document.getElementById("inputGroupSelect1").value;
	const jobs = document.getElementById("jobs-input");

	if (option === "others") {
		jobs.style.display = "block";
	} else jobs.style.display = "hidden";
}


// // File upload
// const form = document.querySelector(".upload-wrapper"),
